    ...
    >
      ...
      >
        <div className="flex flex-col items-center mb-8">
          ...
          <p className="text-slate-600 mt-2 text-center">Join Adwise and unlock your analytics.</p>
        </div>
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          ...
          <button 
            disabled={loading}
            className="w-full mt-6 flex items-center justify-center gap-2 bg-slate-900 text-white font-bold py-4 rounded-xl hover:bg-slate-800 transition-all shadow-lg hover:shadow-xl disabled:opacity-70 disabled:cursor-not-allowed"
          >
        ...
        <p className="mt-8 text-center text-sm text-slate-600 font-medium">
          Already have an account? <Link to="/login" className="text-blue-600 hover:text-blue-800 font-bold ml-1">Log In</Link>
        </p>
      </motion.div>
    </motion.div>
  );
